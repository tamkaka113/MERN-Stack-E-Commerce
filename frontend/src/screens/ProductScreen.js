...
import { listProductDetails, reviewsProduct } from "../actions/productActions";
...
const ProductScreen = ({ match, history }) => {
  ...
  const { success: successProductReviews, error: errorProductReviews } =
    productReviews;
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(reviewsProduct(match.params.id, { rating, comment }));
  };
  return (
    <>
